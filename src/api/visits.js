...
export const visitsApi = {
  ...
  registerEntry: ({ personId, code, entryTime }) =>
    api.post('/api/visits/entry', { personId: personId || null, code: code || null, entryTime: entryTime || null }),

  registerExit: ({ visitId, code, exitTime }) =>
    api.post('/api/visits/exit', { visitId: visitId || null, code: code || null, exitTime: exitTime || null }),
}
